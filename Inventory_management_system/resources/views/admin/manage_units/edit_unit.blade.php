            ...
            <div style="border-radius: 25px;" class="card  shadow-lg p-3 mb-5 bg-body border border-info">
                ...
                <div class="card-body">
                    <div style=" text-align: center;">
                        <div class="line"></div>
                        <h3 class="card-title "> Edit Unit <span style="color:green"> ( {{$viewData->name}} ) </span> Information</h3>
                        <div class="line"></div>
                    </div>
                    ...
                    <form class="forms-sample" method="post" action="{{url('update_unit',$viewData->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex align-items-end flex-column">
                            ...
                            <a href="{{route('all_units')}}" class="btn btn-warning mr-2 border border-light" style="border-radius: 10px;" type="cancel">Back</a>
