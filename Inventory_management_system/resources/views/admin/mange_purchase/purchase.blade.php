                ...
                <table class="table table-striped table-hover table-dark   ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">{{ $sl++ }}</th>
                            <td>{{ $data->name }}
                            <input style="width:100px; height:40px;border-radius: 10px;"
                                    name="product_id[]" value="{{ $data->id }}"
                                    class=""  type="hidden" /> </td>

                            <td>{{ $data->catagory }}</td>
                            <td>{{ $data->unit }}</td>
                            <td> <input style="width:100px; height:40px;border-radius: 10px;"
                                    name="buying_price[]" value="" class=""
                                    type="number" /> </td>
                            <td> <input style="width:100px; height:40px;border-radius: 10px;"
                                    name="selling_price[]" value="" class=""
                                    type="number" /> </td>
                            <td> <input style="width:100px; height:40px;border-radius: 10px;"
                            ...
                            <td class="d-flex " style="text-align: center;">
                                <div>
                                    <a href="" style="border-radius: 10px;"
                                        class="btn btn-danger border border-light"><i class="fa-solid fa-trash"
                        ...
                        <tr>
                            <th colspan="3">
                                <div class="input-group mb-3">
                                    ...
                                    <input style=" height:40px;" name="date" value="{{ date('d/m/y') }}" id="startDate"
                                        class="" type="date" />
                                </div>
                            </th>
                            <td colspan="4"></td>
                            ...
                            <td rowspan="2"></td>
                            <td rowspan="2"><button style="border-radius: 10px; width:100%; height:40px; "
                                    class="btn btn-primary  border border-light" type="submit">submit</button></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="input-group mb-3">
                                    ...
                                    <select style=" height:40px;" name="supplier_id" class="form-select"
