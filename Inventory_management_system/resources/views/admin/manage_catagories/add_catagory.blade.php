    ...
    <div class="">
        <div class="col-md-12 grid-margin stretch-card">
            <div style="border-radius: 25px;" class="card  shadow-lg p-3 mb-5 bg-body border border-info">
                ...
                <div>
                   <a style="color: white" href="{{url('all_catagories')}}"  style="border-radius: 20px; text-decoration:none" type="submit" class="btn btn-info mr-2 border border-light">
                    <i class="fa-regular fa-eye" style="color: #070707;"></i>All Catagories</a>
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample"  >
                        <div class="form-group row " >
                            <label for="supplier" class="col-sm-2 col-form-label">Catagory Name</label>
                            <div class="col-sm-10 ">
